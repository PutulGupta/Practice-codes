...
public class TryWithResourceDemo {
	...
	public static void fileCopyWithArm() throws IOException {
		...
		try (Test t = new Test();Test2 t2 = new Test2(); BufferedInputStream in = new BufferedInputStream(new FileInputStream(inFileStr));BufferedOutputStream out = new BufferedOutputStream(new FileOutputStream(outFileStr))) {
